...
<template>
  <div v-if="show" id="default-modal" tabindex="-1" aria-hidden="true"
    :class="{displayBlock: show}"
    class="fixed inset-0 z-50 overflow-y-auto bg-black flex items-center justify-center">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      <!-- Modal content -->
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-black border">
        <!-- Modal header -->
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
          <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
            Vamos Entrar em Contato!
          </h3>
          <button type="button" @click="$emit('closeModal')" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal">
        ...
        <!-- Modal body -->
        <div class="p-4 md:p-9 flex justify-center items-center gap-6">
          <!-- WhatsApp -->
          <div class="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60" height="50" viewBox="0 0 40R40">
            ...
            <a href="https://whatsa.me/5579999848556/?t=Ol%C3%A1,%20vamos%20iniciar%20um%20novo%20projeto?" class="text-xs md:text-sm font-medium text-foreground" target="_blank">WhatsApp</a>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <a href="https://www.linkedin.com/in/hermes-santos-8596031a0/" class="text-xs md:text-sm font-medium text-foreground" target="_blank">Linkedin</a>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <a href="https://mail.google.com/mail/u/1/#inbox?compose=GTvVlcRzBWcKgwwTLzcpVHhhgZklpjdbBBpPZDJmxCRvBHnbqgRpNPpmkQmxxzWHLgZSLsPpCKrXs" class="text-xs md:text-sm font-medium text-foreground" target="_blank">E-mail</a>
          </div>
        </div>
        <!-- Modal footer -->
