      ...
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-black border">
        ...
        <div class="p-4 md:p-9 flex justify-center items-center gap-6">
          ...
          <div class="flex items-center gap-2">
            ...
            <a href="https://whatsa.me/5579999848556/?t=Ol%C3%A1,%20vamos%20iniciar%20um%20novo%20projeto?" class="text-xs md:text-sm font-medium text-foreground">WhatsApp</a>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <a href="https://www.linkedin.com/in/hermes-santos-8596031a0/" class="text-xs md:text-sm font-medium text-foreground">Linkedin</a>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <a href="https://mail.google.com/mail/u/1/#inbox?compose=GTvVlcRzBWcKgwwTLzcpVHhhgZklpjdbBBpPZDJmxCRvBHnbqgRpNPpmkQmxxzWHLgZSLsPpCKrXs" class="text-xs md:text-sm font-medium text-foreground">E-mail</a>
          </div>
        </div>
        <!-- Modal footer -->
